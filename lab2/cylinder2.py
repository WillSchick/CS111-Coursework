...
print("height = %.2f, radius = %.2f" % (height, radius)) #Print the input from before to clarify (Rounded in case it was too crazy))
print("--- --- " * 5) #Divider
print("   area          = %10.2f" % (area)) #Print the area, rounded
print("   volume        = %10.2f" % (volume)) #Print the volume, rounded
print("   circumference = %10.2f" % (cir)) # Print the circumferance, rounded
